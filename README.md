...
[travis-badge]: https://travis-ci.org/filipesilva/angular-talk-core.svg?branch=master
[travis-badge-url]: https://travis-ci.org/filipesilva/angular-talk-core
...
1. Create a project folder (you can call it `talk-core` and rename it later).
...
```
git clone https://github.com/filipesilva/angular-talk-core.git
cd angular-talk-core
npm install
npm start
```
...
### Download
[Download the QuickStart Library seed](https://github.com/filipesilva/angular-talk-core/archive/master.zip)
...
Use your editor to search the project for all instances of `talk-core` and change it
...
"# talk-core" 
"# talk-core"  git init git add README.md git commit -m "first commit" git remote add origin https://github.com/lfmm/talk-core.git git push -u origin master
